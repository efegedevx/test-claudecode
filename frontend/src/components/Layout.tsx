    ...
    <div className="layout">
      <aside className="sidebar">
        <div className="sidebar-logo">
          ...
          <span className="logo-text">HATUN</span>
        </div>
        <nav className="sidebar-nav">
          <div className="nav-section">
            <button className="nav-item">
              ...
              <svg className="chevron" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 18 15 12 9 6"/></svg>
            </button>
          </div>
          <div className="nav-section expanded">
            <button className="nav-item">
              ...
              <svg className="chevron down" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 18 15 12 9 6"/></svg>
            </button>
            <div className="nav-children">
              <NavLink to="/operaciones" className="nav-child">
              ...
              <NavLink to="/calendario-comunicaciones" className="nav-child">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                <span>Calendario de Comunicaciones</span>
              </NavLink>
            </div>
          </div>
        </nav>
